...
class Musify():
	...
	def starting(self):
		self.MusifyIcon = PhotoImage(file = "asset/Musify.png")
		self.blueFrame = Frame(self.window,bg=self.BLUE)
		self.Icon = Label(self.blueFrame,image = self.MusifyIcon,bg=self.BLUE)
	...
	def barFunc(self):
		...
		# serch input
		self.Musify = Label(self.arrowFrame,bg=self.dg,font="arial 12 ",bd=0,text="Musify                                            ",fg=self.white,pady=7)
		self.Musify.grid(row=0,column=1)
